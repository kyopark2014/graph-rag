...
# title
st.set_page_config(page_title='graph-rag', page_icon=None, layout="centered", initial_sidebar_state="auto", menu_items=None)
...
with st.sidebar:
    ...
    st.markdown(
        ...
        "상세한 코드는 [Github](https://github.com/kyopark2014/graph-rag)을 참조하세요."
    )
    ...
    if mode=='Agent' or mode=='Agent (Chat)':
        ...
        mcp_selections = {}
        default_selections = ["knowledge base", "web_fetch", "korea_weather", "websearch"]
    ...
    if mode=='이미지 분석':
        ...
        uploaded_file = st.file_uploader(
            "RAG를 위한 파일을 선택합니다.",
            type=["pdf", "txt", "py", "md", "csv", "json", "png", "jpg", "jpeg"],
            key=chat.fileId,
        )
